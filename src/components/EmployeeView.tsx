        ...
        <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg border shadow-sm">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-gray-900">Widok Pracownika</h2>
                            <p className="text-sm text-gray-600">Osobisty kalendarz i statystyki</p>
                        </div>
                    </div>
            ...
            <div className="bg-white p-6 rounded-lg border shadow-sm">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-lg font-bold text-gray-900">Preferencje dla AI Doradcy</h3>
                </div>
                ...
                <textarea
                    ...
                    className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-purple-500 outline-none min-h-[80px] text-sm"
                />
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                <div className="bg-white p-4 rounded-lg border shadow-sm">
                    <div className="text-sm text-gray-600">Dni robocze</div>
                    <div className="text-2xl font-bold text-blue-600">{stats.workDays}</div>
                </div>
                <div className="bg-white p-4 rounded-lg border shadow-sm">
                    <div className="text-sm text-gray-600">Urlop (UW)</div>
                    <div className="text-2xl font-bold text-green-600">{stats.vacDays}</div>
                </div>
                <div className="bg-white p-4 rounded-lg border shadow-sm">
                    <div className="text-sm text-gray-600">Choroba (L4)</div>
                    <div className="text-2xl font-bold text-orange-600">{stats.sickDays}</div>
                </div>
                <div className="bg-white p-4 rounded-lg border shadow-sm">
                    <div className="text-sm text-gray-600">Godziny kontaktów</div>
                    <div className="text-2xl font-bold text-purple-600">{stats.contactHours}h</div>
                </div>
                <div className="bg-white p-4 rounded-lg border shadow-sm">
                    <div className="text-sm text-gray-600">Suma godzin</div>
                        ...
                        return (
                            <div
                                ...
                                className={clsx(
                                    ...
                                    shift?.type === 'WORK' && "bg-blue-50 border-blue-300",
                                    shift?.type === 'UW' && "bg-green-50 border-green-300",
                                    shift?.type === 'L4' && "bg-orange-50 border-orange-300",
                                    !shift && "bg-white"
                                )}
                            >
                                ...
                                {shift && (
                                    <div className="text-xs">
                                        {shift.type === 'WORK' && shift.startHour !== undefined && shift.endHour !== undefined ? (
                                            ...
                                            <div className={clsx(
                                                "font-medium",
                                                shift.type === 'UW' && "text-green-700",
                                                shift.type === 'L4' && "text-orange-700"
                                            )}>
                                                {shift.type}
                                            </div>
                                        )}
                                        <div className="text-gray-600 mt-1">{shift.hours}h</div>
                                    </div>
                                )}
                            </div>
                        );
